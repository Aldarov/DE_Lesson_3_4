...
#     create_db = DummyOperator(task_id='create_db')
...
#     hello_task >> python_task1 >> add_numbers_to_file >> result_calculation >> check_file >> branch_check_file >> [create_db, task_to_fail]
